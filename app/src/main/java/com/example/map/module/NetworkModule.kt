...
const val DIRECTIONSAPIBASEURL = "https://maps.googleapis.com/maps/api/directions/"

val networkModule = module {
    single { createWebService<DirectionsAPI>(RxJava2CallAdapterFactory.create(), DIRECTIONSAPIBASEURL) }
